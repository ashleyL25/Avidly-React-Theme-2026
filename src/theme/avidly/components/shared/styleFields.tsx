 ...
 * - Container width (container/full-width/custom)
 * - Custom container width (px)
 * - Responsive spacing (desktop/tablet/mobile)
 * - Background options (image/color/gradient)
 ...
 * - Custom ID
 */
export const StyleFields = ({ name, label, default: defaultValues }: StyleFieldsProps) => (
  <GroupField name={name} label={label} default={defaultValues}>
    ...
    {/* Responsive Spacing */}
    <GroupField name="spacing" label="Spacing" default={{
      desktop: {
        padding: { top: { value: 80, units: 'px' }, bottom: { value: 80, units: 'px' }, left: { value: 0, units: 'px' }, right: { value: 0, units: 'px' } }
      },
      tablet: {
        padding: { top: { value: 60, units: 'px' }, bottom: { value: 60, units: 'px' }, left: { value: 0, units: 'px' }, right: { value: 0, units: 'px' } }
      },
      mobile: {
        padding: { top: { value: 40, units: 'px' }, bottom: { value: 40, units: 'px' }, left: { value: 0, units: 'px' }, right: { value: 0, units: 'px' } }
      }
    }}>
      <SpacingField
        name="desktop"
