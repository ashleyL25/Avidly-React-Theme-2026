...
export default function HeaderIsland({
  ...
  phone = '(888).123.456.7894',
  address = '629 Elgin St.Celina,2202',
  showTopBar = true,
  facebookUrl = '#',
  twitterUrl = '#',
  linkedinUrl = '#',
  ...
  return (
    <>
      <header
        className={`header-section style-five ${isSticky ? 'sticky-on' : ''}`}
      >
        {showTopBar && (
              ...
              <div className="h-100 d-flex align-items-center justify-content-between">
                <div className="left-side d-flex align-items-center gap-2 gap-md-3 gap-lg-4">
                  ...
                  >
                    ...
                    <span className="d-none d-lg-block">{address}</span>
                  </a>
        ...
        <nav className="navbar navbar-expand-xl">
          <div className="container">
            <a className="navbar-brand" href="/">
              <img
                src={logo?.src || '/assets/img/core-img/logo.png'}
                alt={logo?.alt || 'Startix Logo'}
            ...
            >
              ...
              <div className="header-navigation ms-auto d-flex flex-wrap align-items-center mt-4 mt-xl-0">
                ...
                <a className="btn btn-primary" href={ctaUrl}>
                  <span>
                    {ctaText} <i className="ti ti-arrow-up-right"></i>
                  </span>
                  <span>
                    {ctaText} <i className="ti ti-arrow-up-right"></i>
                  </span>
